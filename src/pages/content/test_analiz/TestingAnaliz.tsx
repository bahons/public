...
export const TestingAnaliz = () => {
   ...
   const testFinishHandler = () => dispatch(finishTest5({ type: "analiz" }));

   useEffect(() => {
      confirm ? dispatch(startTimer({ panId: 555 })) : history.push(`/TestWorkAnaliz/${fiveId}`);
                           ...
                           return (
                              ...
                              >
                                 ...
                                 {item.topUrl && (
                                    <>
                                       <br />
                                       <img src={BASE_URL_ANALIZ_IMG + item.topUrl} style={imgStyle} alt="" />
                                    </>
                                 )}
                                 {item.name && (
                                    <p
                                 ...
                                 {item.buttomUrl && (
                                    <img src={BASE_URL_ANALIZ_IMG + item.buttomUrl} style={imgStyle} alt="" />
                                 )}
                                 {item.name2 && (
                                    <p
                                       className="test-text"
